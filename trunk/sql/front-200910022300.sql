...
CREATE TABLE "front_userbio" (
    "rateablestuff_ptr_id" integer NOT NULL PRIMARY KEY REFERENCES "front_rateablestuff" ("id") DEFERRABLE INITIALLY DEFERRED,
    "theBio" text NOT NULL,
    "user_id" integer NOT NULL UNIQUE REFERENCES "front_rateableuser" ("rateablestuff_ptr_id") DEFERRABLE INITIALLY DEFERRED
)
;
...
;
CREATE TABLE "front_passwordresetrequest" (
    "id" serial NOT NULL PRIMARY KEY,
    "uuid" varchar(36) NOT NULL UNIQUE,
    "requestedAt" timestamp with time zone NOT NULL,
    "expiresAt" timestamp with time zone NOT NULL,
...
CREATE INDEX "front_passwordresetrequest_user_id" ON "front_passwordresetrequest" ("user_id");
COMMIT;
